  ...
  internal class BranchGene : IGene
  {
    public BranchGene(MethodInfo mi) {
      ...
      if (mi.ReturnType != typeof(bool)) {
        throw new ArgumentException(Resources.BranchGene_MethodMustReturnBool, "mi");
      }
      ...
      if (
        ...
        throw new ArgumentException(Resources.BranchGene_MethodParametersMustDeriveFromIParameter, "mi");
      }
